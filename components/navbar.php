...
<div class="agileits_header">
    <div class="container">
        <div class="w3l_offers">
            <p>100% Kopi Asli Yang Setia Menemani Aktivitasmu . <a href="?page=pages/produk/view">SHOP NOW</a></p>
        </div>
        <div class="agile-login">
            <ul>
                <li><a href="?page=register"> Buat Akun </a></li>
                <!-- <li><a href="?page=login">Login</a></li> -->
                <li><a href="?page=pages/petunjuk/view">Petunjuk Pesan</a></li>

            </ul>
        </div>
        <div class="product_list_header">
            <a href="?page=pages/pemesan/view">
    ...
    <div class="container">
        <div class="w3ls_logo_products_left1">
            <ul class="phone_email">
                <li><i class="fa fa-phone" aria-hidden="true"></i>Pesan Online Hubungi : +6281295941738</li>

            </ul>
        </div>
        <div class="w3ls_logo_products_left">
            <h1><a href="index.html">Kopi Kiniko</a></h1>
        </div>
        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="?=page=home" class="act">Home</a></li>
                    <!-- Mega Menu -->
                    <!-- <li class="dropdown">
                    ...
                    <li><a href="?page=pages/produk/view">Produk</a></li>
                    <li><a href="?page=pages/pemesan/view">Pemesanan</a></li>
                    <li><a href="?page=pages/profil/view">Profil</a></li>
                    <li><a href="?page=pages/petunjuk/view">Petunjuk Pesan</a></li>
